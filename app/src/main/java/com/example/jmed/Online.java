...
public class Online extends AppCompatActivity {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if(hasFocus) {
            ...
            ServerSocket SS1 = IpThread.SS1;
            ServerSocket SS2 = IpThread.SS2;
            ...
            switch(id) {
                case 0:
                    S[0] = new Server(this,1,S1,SS1);
                    S[1] = new Server(this,2,S2,SS2);
                    break;
                case 1:
                    S[0] = new Server(this,0,S1,SS1);
                    S[1] = new Server(this,2,S2,SS2);
                    break;
                case 2:
                    S[0] = new Server(this,0,S1,SS1);
                    S[1] = new Server(this,1,S2,SS2);
                    break;
                default:
                    break;
